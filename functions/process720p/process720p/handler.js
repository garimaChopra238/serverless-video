...
module.exports = event => {
  ...
  ffmpeg(readStream)
    ...
    .outputOptions(['-vf scale=w=1280:h=720', '-c:a aac', '-ar 48000', '-b:a 128k', '-c:v h264', '-profile:v main', '-crf 20', '-g 48', '-keyint_min 48', '-sc_threshold 0', '-b:v 2800k', '-maxrate 2996k', '-bufsize 4200k', '-f hls', '-hls_time 4', '-hls_playlist_type vod', `-hls_segment_filename /tmp/${id}/720p_%d.ts`])
