...
module.exports = event => {
  ...
  ffmpeg(readStream)
    ...
    .outputOptions(['-vf scale=w=1920:h=1080', '-c:a aac', '-ar 48000', '-b:a 192k', '-c:v h264', '-profile:v main', '-crf 20', '-g 48', '-keyint_min 48', '-sc_threshold 0', '-b:v 5000k', '-maxrate 5350k', '-bufsize 7500k', '-f hls', '-hls_time 4', '-hls_playlist_type vod', `-hls_segment_filename /tmp/${id}/1080p_%d.ts`])
